...
# Configuration
# Repository identity is configurable so fork-owned installers and updates do
# not silently switch back to the official repository. Existing checkouts keep
# following their own origin; this setting controls fresh clones.
HERMES_REPOSITORY="${HERMES_REPOSITORY:-NousResearch/hermes-agent}"
REPO_URL_SSH="${HERMES_REPO_URL_SSH:-git@github.com:${HERMES_REPOSITORY}.git}"
REPO_URL_HTTPS="${HERMES_REPO_URL_HTTPS:-https://github.com/${HERMES_REPOSITORY}.git}"
